...
public class Dispatcher {
    ...
    public static void main(String[] args) {
        ...
        /*
         * Il dispatcher crea una destination di coda richieste per parlare 
         * con un client Python, una volta ricevuta la richiesta 
         * (asincrona tramite MessageListener) di operazione parlerà tramite
         * Proxy-Skeleton (socket) verso il server
         * 
         */
        ...
        try{ 
            ...
            //passo al listener la sessione, la coda di risposte e il numero
            //di porto (ricevuto da terminale) in modo da inviare il messaggio al server
